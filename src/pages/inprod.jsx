...
const ProductPage = () => {
  return (
   <>
   <div>
          <hr className="my-3" /><div className="flex justify-between mt-6">
              <div className="flex">
              ...
              <div className="flex">
                  <img className="h-20 w-20 object-cover rounded" src={f3} alt />
                  <div className="mx-3">
                      <h3 className="text-sm text-gray-600">Mac Book Pro</h3>
                      <div className="flex items-center mt-2">
                          <button className="text-gray-500 focus:outline-none focus:text-gray-600">
          ...
          </div><a className="flex items-center justify-center mt-4 px-3 py-2 bg-blue-600 text-white text-sm uppercase font-medium rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
              <span>Checkout</span>
              ...
              </main><footer className="bg-gray-200">
