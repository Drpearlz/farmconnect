  ...
  return (
    <div class="">
      <img
        src={imgg}
        alt=""
        class="h-32 w-[300px] max-md:h-28 object-cover rounded-lg"
      />
      ...
      <div class='grid grid-cols-3 max-md:grid-cols-2 gap-5 my-2'>
        <Paragraph
          text="Vegatable"
          styles=" max-md:text-[.6rem]  p-3 max-md:p-1 text-center bg-green-100 rounded-md   "
        />
        <Paragraph
          text="Vegatable"
          styles=" max-md:text-[.6rem]  p-3 max-md:p-1 text-center bg-green-100 rounded-md   "
